...
public class BlogService {
    ...
    // this is the constructor for BlogService class which takes BlogRepository as a parameter and initializes the repo field
    public BlogService(BlogRepository repo) {
        this.repo = repo;
    }


    // this method returns a list of all blogs by calling the findAll() method of BlogRepository
    public List<Blog> listAll() {
        return repo.findAll();
    }


    // this method creates a new blog by saving the provided Blogs object using the save() method of BlogRepository
    ...
    public Blog updateStatus(Long id, String status) {
        Blog blog = repo.findById(id).orElseThrow();       // this line fetches the blog with the given id from the repository, or throws an exception if not found
    ...
    // this method deletes a blog by its ID using the deleteById() method of BlogRepository
