...
public class ImageService {         // defining ImageService class
    ...
    // this method creates a new image by saving the provided Image object using the save() method of ImageRepository
    ...
    // this method deletes an image by its ID using the deleteById() method of ImageRepository
